...
zato si je smiselno podrobneje ogledati posamezne korake.
   ...
   $sre$\text{\v{c}}$anja_i$, ki ga sestavlja $predmet_i$, profesor, ki ta predmet predava,
   ...
   Ko preverimo vse proste termine vseh predavalnic, vstavimo $sre \text{č} anje_i$
...
spremembo (npr. zamenjava $s\text{rečanja}_i$ in $s\text{rečanja}_j$) sedaj shranimo v
...
\subsubsection{Končni algoritem} % podrazdelek
